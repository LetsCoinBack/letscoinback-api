...
import br.com.letscoinback.persistence.repository.MasterConfigurationRepository;
...
public class MasterConfigurationService {
	...
	@Autowired
	MasterConfigurationRepository configurationRepository;
	...
	public void save (ConfigurationDTO config) {
		...
		configurationRepository.save(modelMapper.map(config, MasterConfigurationEntity.class));
	}
